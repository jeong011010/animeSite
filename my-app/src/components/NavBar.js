          ...
          <div className={styles.d}>
            <div className={styles.d}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.222 16.657a7.608 7.608 0 111.435-1.435l4.05 4.05a1 1 0 010 1.415l-.02.02a1 1 0 01-1.415 0l-4.05-4.05zm.994-6.05a5.608 5.608 0 11-11.216 0 5.608 5.608 0 0111.216 0z" fill="currentColor"></path>
              </svg>
              <div className={styles.d}>
                <input data-cy="search-input" placeholder="제목, 제작사, 감독으로 검색 (초성)" className={styles.d} value="" />
              </div>
            </div>
